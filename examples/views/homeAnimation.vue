<template>
  <div class="template-container">
    <button class="start"
            @click.stop="showAniFunc">pageCurrentZindex=={{pageCurrentZindex}}</button>
    <button class="reset"
            @click.stop="showAniFuncReset">reset</button>
    <div class="page-one"
         style="width: 100vw;height: 100vh;background: antiquewhite;position: absolute; top:0;"
         :style="{zIndex: pageCurrentZindex === 0 ? 99 : 0}">
      page-onepage-onepage-onepage-onepage-one
      <div class="circle"
           :class="pageOneAnimateName"
           style="width: 30vw;height: 30vh;background: blue;">
        test circle
      </div>
    </div>
    <div class="page-four"
         :style="{zIndex: pageCurrentZindex === 3 ? 99 : 0}">
      <IconPage :page-current-zindex="pageCurrentZindex"></IconPage>
    </div>
  </div>
</template>
